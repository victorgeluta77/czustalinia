...
<title>Прибирання Львів | Чиста Лінія</title>
...
<meta name="description" content="Прибирання квартири Львів Чиста Лінія ☎ +38(067)-3701492 : вивіз будівельного сміття, послуги з прибирання приміщень, прибирання будинків львів якісно та оперативно.">
...
<link rel="stylesheet" href="assets/animation_text.css">
</head>
<body>
...
<p class="text-center cz_linia_text">Дякуємо, що скористались нашим сервісом. Невдовзі, наш менеджер зателефонує до Вас!!!</p> 
   <div class="cz_linia_wrapper">
...
<script src="assets/animation_text.js"></script>
