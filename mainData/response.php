...
<title>Миття квартир після ремонту| Чиста Лінія</title>
...
<meta name="description" content="Уборка помещений после ремонта Чиста Лінія ☎ +38(067)-3701492 : цены на уборку квартиры после ремонта, приятная цена, качество обслуживания.">
...
<h2 class="text-center wowload fadeInUp">Прибирання та емоції наколо !!!</h2>  
  <div class="row">
  <div class="col-sm-6 wowload fadeInLeft">
    <h1>
      <img src="img/logo02_mini.png" alt="">
       Професійне прибирання.</h1>
    <p>Чисто, приємно, момент, що надихає - культура, професійний ріст , з іншої сторони - відпочинок, коли все на місці і з внутрішьою свободою летиш вперед.</p>
  </div>
  <div class="col-sm-6 wowload fadeInRight">
  <h1>
    <img src="img/logo05_mini.png" alt=""> Емоції</h1>
  <p>Простір, котрий оточує навколо. Все на своєму місці. Магія. Час щоб відпочити та творити! Діліться з нами своїми мріями та емоціями. <br> Нам це важливо!</p>    
  </div>
  </div>
...
<div id="works"  class=" clearfix grid"> 
    <figure class="effect-oscar  wowload fadeInUp">
     ...
     <figure class="effect-oscar  wowload fadeInUp">
        <img src="img/our_work/tradingHall.jpg" alt="Торгівельні площі"/>
        <figcaption>
            <h2>Супермаркет</h2>
            <p>
              <!-- Lily likes to play with crayons and pencils<br> -->
            <a href="img/our_work/tradingHall.jpg" title="Торгівельні площі" data-gallery>детальніше</a></p>            
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
     ...
     <figure class="effect-oscar  wowload fadeInUp">
        <img src="img/portfolio/kitchen 2.jpg" alt="Кухонні меблі"/>
        <figcaption>
            <h2>Кухня</h2>
            <p>
              <!-- Lily likes to play with crayons and pencils<br> -->
    ...
    <figure class="effect-oscar  wowload fadeInUp">
        <img src="img/our_work/vacuumRoom.jpg" alt="Порохотяг для професійного прибирання"/>
        <figcaption>
            <h2>Порохотяг</h2>
            <p>
              <!-- Lily likes to play with crayons and pencils<br> -->
            <a href="img/our_work/vacuumRoom.jpg" title="Порохотяг для професійного прибирання" data-gallery>детальніше</a></p>            
        </figcaption>
    </figure>
    <figure class="effect-oscar  wowload fadeInUp">
        <img src="img/our_work/wallOutside.jpg" alt="Зовнішні стіни"/>
        <figcaption>
            <h2>Стіна</h2>
            <p>
              <!-- Lily likes to play with crayons and pencils<br> -->
            <a href="img/our_work/wallOutside.jpg" title="Зовнішні стіни" data-gallery>детальніше</a></p>            
        </figcaption>
    </figure>
