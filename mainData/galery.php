...
<meta name="description" content="Клининговая уборка помещений Чиста Лінія ☎ +38(067)-3701492 : засіб для миття вікон, клининг, клининг львов, клінінгова компанія львів ціни.">
...
<div class="cz_lin_partneru">
  <h3 class="text-center">Виконані замовлення</h3> 
  <h1 class="text-center">Прибирання приватного будинку (с.Малехів)</h1> 
    <div class="cz_lin_partneru_dani">
   
        <div class="cz_lin_partneru_img_text">
        <img class="cz_lin_partneru_img" src="img/galery/malehiv/01_mal.jpg" alt="клининг львов Адідас">
        </div>   
        <div class="cz_lin_partneru_img_text">
        <img class="cz_lin_partneru_img" src="img/galery/malehiv/02_mal.jpg" alt="клининговая уборка помещений Аквапарк">
        </div> 
        <div class="cz_lin_partneru_img_text">
        <img class="cz_lin_partneru_img" src="img/galery/malehiv/03_mal.jpg" alt="Прибирання офісів Big Star">
        </div>
        <div class="cz_lin_partneru_img_text">
        <img class="cz_lin_partneru_img" src="img/galery/malehiv/04_mal.jpg" alt="Прибирання офісів Big Star">
        </div>
        <div class="cz_lin_partneru_img_text">   
        <img class="cz_lin_partneru_img" src="img/galery/malehiv/05_mal.jpg" alt="клінінг після ремонту львів">
        </div>
        <div class="cz_lin_partneru_img_text">
        <img class="cz_lin_partneru_img" src="img/galery/malehiv/06_mal.jpg" alt="послуги з прибирання приміщень">
        </div>
